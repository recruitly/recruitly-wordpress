<?php
/**
 * Shows the job listing for the given tagkey:tagvalue.
 *
 * This template can be overridden by copying it to yourtheme/recruitly/job-tag-widget.php
 *
 * @author      Recruitly
 * @package     Recruitly
 * @category    Template
...
<div class="recruitly_sector_jobs">
    ...
    if ( $wp_query->have_posts() ) {
        ...
        <div class="cool-job-sector-footer">
            <a class="cool-job-sector-viewall-link" title="View All" href="<?php echo esc_attr( $target ); ?>?job_search=&job_tag=<?php echo esc_attr( $tagvalue ); ?>">View All</a>
        </div>
        <?php
    }?>
</div>